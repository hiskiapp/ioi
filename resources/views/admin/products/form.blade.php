...
<link rel="stylesheet" href="{{ asset('plugins/image-uploader/dist/image-uploader.min.css') }}">
@endpush
@section('content')
        ...
        <form class='form-horizontal' method='post' id="form" enctype="multipart/form-data"
            ...
            <div class="box-body" id="parent-form-area">
                ...
                <div class='form-group header-group-0 ' id='form-group-name' style="">
                    ...
                    <div class="col-sm-10">
                        <input type='text' title="Name" required placeholder=''
                            maxlength=70 class='form-control' name="name" id="name" value='{{ old('name', optional($row)->name) }}' />
                ...
                <div class='form-group header-group-0 ' id='form-group-permalink' style="">
                    ...
                    <div class="col-sm-10">
                        <input type='text' title="Permalink" required maxlength=255 class='form-control'
                            name="permalink" id="permalink" value='{{ old('permalink', optional($row)->permalink) }}' />
                ...
                <div class='form-group header-group-0 ' id='form-group-categories_id' style="">
                    ...
                    <div class="col-sm-10">
                        <select class='form-control' id="categories_id" data-value='' name="categories_id">
                            <option value=''>** Please select a Category</option>
                            @foreach ($categories as $category)
                            <option value='{{ $category->id }}' @if(old('categories_id', optional($row)->categories_id) == $category->id) selected @endif>{{ $category->name }}</option>
                            @endforeach
                        </select>
                        <div class="text-danger"></div>
                        <p class='help-block'></p>
                ...
                <div class='form-group header-group-0 ' id='form-group-sub_categories_id' style="">
...
<script src="{{ asset('plugins/image-uploader/dist/image-uploader.min.js') }}"></script>
<script>
    $(function() {
