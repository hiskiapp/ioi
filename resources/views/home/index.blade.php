...
@section('content')
    ...
    <!-- product area end -->
    <!-- product area start -->
    <div class="product-style-area pt-120 mb-20 @if (get_setting('show_testimonial') == 'No' && get_setting('show_feature_footer') == 'No') pb-80 @endif">
        <div class="coustom-container-fluid">
            ...
            <div class="tab-content">
                @foreach ($all_products as $category)
                    <div class="tab-pane @if ($loop->iteration == 1) active @endif show fade"
                        id="category{{ $loop->iteration }}" role="tabpanel">
