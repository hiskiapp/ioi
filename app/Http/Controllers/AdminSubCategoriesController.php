<?php namespace App\Http\Controllers;
	...
	class AdminSubCategoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Parent Category","name"=>"categories_id","join"=>"categories,name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Parent Category','name'=>'categories_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'categories,name'];
