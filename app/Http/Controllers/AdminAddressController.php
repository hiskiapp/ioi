<?php namespace App\Http\Controllers;
	...
	class AdminAddressController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Main Address","name"=>"main_address"];
			$this->col[] = ["label"=>"Receive Name","name"=>"receive_name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'User','name'=>'users_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'users,name'];
			$this->form[] = ['label'=>'Main Address','name'=>'main_address','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Receive Name','name'=>'receive_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Detail','name'=>'detail','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Note','name'=>'note','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			# END FORM DO NOT REMOVE THIS LINE

			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Users Id","name"=>"users_id","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"users,name"];
			//$this->form[] = ["label"=>"Main Address","name"=>"main_address","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"Receive Name","name"=>"receive_name","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
