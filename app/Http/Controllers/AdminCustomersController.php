<?php namespace App\Http\Controllers;
	...
	class AdminCustomersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Gender','name'=>'gender','type'=>'select','validation'=>'required','width'=>'col-sm-10','dataenum'=>'Male;Female'];
	        ...
	        */
			...
			$this->sub_module[] = ['label'=>'Cart','path'=>'carts','parent_columns'=>'name','foreign_key'=>'users_id','button_color'=>'success','button_icon'=>'fa fa-shopping-cart'];
			$this->sub_module[] = ['label'=>'Address','path'=>'address','parent_columns'=>'name','foreign_key'=>'users_id','button_color'=>'info','button_icon'=>'fa fa-road'];
